        ...
        <aside id="sidebar" class="sidebar">
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    >
                        <li>
                            <a href="pages/airline/add.php">
                                <i class="bi bi-circle"></i
                                ><span>Airlines</span>
                            </a>
                        </li>
                        <li>
                            <a href="../../pages/airport/add.php">
                                <i class="bi bi-circle"></i
                                ><span>Airport</span>
                            </a>
                        </li>
                        <li>
                            <a href="../../pages/flight/add.php">
                                <i class="bi bi-circle"></i
                                ><span>Flight</span>
                            </a>
                        </li>
                        <li>
                            <a href="pages/fly/add.php">
                                <i class="bi bi-circle"></i
                                ><span>Routes</span>
                            </a>
                        </li>
                        <li>
                            <a href="../../pages/passengers/view-passengers.php">
                                <i class="bi bi-circle"></i><span>Passengers</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    >
                        <li>
                            <a href="../../pages/airport/update.php">
                                <i class="bi bi-circle"></i
                                ><span>Airports</span>
                            </a>
                        </li>                       
                        <li>
                            <a href="../../pages/airline/update.php">
                                <i class="bi bi-circle"></i
                                ><span>Airlines</span>
                            </a>
                        </li>
                        <li>
                            <a href="../../pages/flight/update.php">
                                <i class="bi bi-circle"></i
                                ><span>Flights</span>
                            </a>
                        </li>
                        <li>
                            <a href="../../pages/fly/update.php">
                                <i class="bi bi-circle"></i
                                ><span>Routes</span>
                            </a>
                        </li>
